var CanvasParticle = (function(){
	...
	function canvasInit(canvasConfig){
		...
		var body = document.getElementById("particle_background");
	...
	function canvasSize(canvas){
		...
		// 获取特定div的宽高
		var width = document.getElementById("particle_background").style.width;
		var height = document.getElementById("particle_background").style.height;
